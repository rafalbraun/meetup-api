...
public class GroupController {
    ...
    public ResponseEntity<GroupDto> getGroup(@PathVariable Long id) throws ResourceNotFoundException {
        GroupDto group = groupService.getGroup(id);
        return ResponseEntity.ok().body(group);
    }

    @PostMapping(CREATE_GROUP)
    public ResponseEntity<GroupDto> createGroup(@Valid @RequestBody GroupDto request) throws ResourceNotFoundException {
